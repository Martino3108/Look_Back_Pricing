...
The pricing methodology follows the approach described in Stéphane Crépey (2013), Section 6.\+9, and is based on an exact simulation of the joint distribution of the process and its running maximum.
...
\begin{DoxyNote}{Note}
The algorithm implemented here is valid under the assumptions described in the reference.
\end{DoxyNote}
