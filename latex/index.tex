...
where $ W_t $ is a standard Brownian motion. This dynamics corresponds to the explicit solution of the Black-\/\+Scholes model (applied to log-\/prices). The associated running maximum process is defined as:\+
