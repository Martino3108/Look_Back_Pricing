...
int main(int argc, const char * argv[]) {
    look_back l(100, 1, 0.2, 0.05, "CALL", 100000, 0.01);
    
   
    std::cout<<l.price(100,0.20,0.05,1)<<std::endl;
    ...
    //std::array<vect, 2> g1=l.graphic_price(0.05);
    //std::array<vect, 2> g2=l.graphic_delta(0.05);
